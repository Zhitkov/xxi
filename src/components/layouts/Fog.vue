...
export default {
  ...
  mounted(){
    ...
    var canvasWidth = 1600, canvasHeight = 200, pCount = 0, pCollection = new Array(), puffs = 1, particlesPerPuff = 2000, img = 'https://cdn.pixabay.com/photo/2016/04/17/22/45/globe-1335720_960_720.png', smokeImage = new Image();
