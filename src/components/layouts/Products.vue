<template>
	<div class="products">
		<div  class="container" v-for="product in products">
			<div :alt="product.name" @mouseover="mouseOver(product.name)" @mouseleave="mouseLeave(product.name)">
				<img :alt="product.name" class="inner" :src="product.src">
			</div>
		</div>
	</div>
</template>
...
mounted(){
	...
	methods:{
		...
		mouseOver: function(name){
			document.querySelector('div[alt="'+name+'"]').id="container";
			document.querySelector('img[alt="'+name+'"]').id="inner";
		...
		mouseLeave: function(name){
			document.querySelector('div[alt="'+name+'"]').removeAttribute('id');
			document.querySelector('img[alt="'+name+'"]').removeAttribute('id');
		}
	}
}
</script>
