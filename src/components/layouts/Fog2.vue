...
export default {
  ...
  mounted(){
    ...
    var canvasWidth = 1600, canvasHeight = 200, pCount = 0, pCollection = new Array(), puffs = 1, particlesPerPuff = 2000, img = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/85280/smoke2.png', smokeImage = new Image();
